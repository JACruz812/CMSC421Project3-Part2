...
asmlinkage long sys_mbox_init_421(void);
asmlinkage long sys_mbox_shutdown_421(void);
asmlinkage long sys_mbox_open_421(char __user* name, mailbox_id_t __user *id, uint64_t size);
asmlinkage long sys_mbox_write_421(mailbox_id_t __user *id, uint8_t __user *data, uint64_t size, uint64_t offset);
asmlinkage long sys_mbox_read_421(mailbox_id_t __user *id, uint8_t __user *data, uint64_t size, uint64_t offset);
asmlinkage long sys_mbox_close_421(mailbox_id_t __user *id);
#endif
